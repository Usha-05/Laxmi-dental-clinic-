              ...
              >
                ...
                <div className="p-6 flex flex-col items-center text-center flex-1">
                  ...
                  <div className="w-16 h-16 rounded-2xl bg-white shadow-lg flex items-center justify-center border-2 border-emerald-100 group-hover:border-emerald-200 transition-colors duration-300">
                      <IconComponent size={30} className="text-emerald-600 group-hover:text-emerald-700 transition-colors duration-300" />
                    </div>
                  </div>
                  
                  {/* Title */}
                  <h3 className="text-2xl md:text-3xl font-bold text-emerald-700 mb-3 group-hover:text-emerald-800 transition-colors duration-300 tracking-tight">
                    {expertise.name}
                  </h3>
