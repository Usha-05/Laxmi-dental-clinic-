    ...
    <section id="treatments" className="py-8 md:py-12 lg:py-16 bg-gradient-to-b from-[#d1fae5] via-[#ecfdf5] to-white relative overflow-hidden">
      ...
      <div className="w-full px-2 sm:px-4 lg:px-6 relative z-10">
        <div className="text-center mb-8 md:mb-12 lg:mb-16 space-y-3 md:space-y-4">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold text-emerald-700 mb-4 tracking-tight leading-tight">Comprehensive Dental Care</h2>
          <p className="text-gray-600 text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed font-medium px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 w-full">
          {expertiseData.map((expertise) => {
            ...
            return (
              <div
                key={expertise.name}
                className="group relative bg-white rounded-2xl overflow-hidden border border-emerald-100/80 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 ease-out flex flex-col h-full"
              >
                {/* Category Header */}
                <div className="bg-gradient-to-r from-[#1E603F] to-[#289660] text-white px-6 py-3">
                  <p className="text-sm font-semibold uppercase tracking-wide">{expertise.category}</p>
                </div>
                
                {/* Image Section */}
                <div className="relative w-full aspect-[4/3] min-h-[280px] sm:min-h-[320px] md:min-h-[360px] overflow-hidden bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-emerald-900/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
                </div>
                ...
                <div className="p-6 flex flex-col items-center text-center flex-1">
                  ...
                  <div className="relative -mt-12 mb-4">
                    <div className="w-20 h-20 rounded-2xl bg-white shadow-lg flex items-center justify-center border-2 border-emerald-100 group-hover:border-emerald-200 transition-colors duration-300">
                      <IconComponent size={36} className="text-emerald-600 group-hover:text-emerald-700 transition-colors duration-300" />
                    </div>
                  </div>
                  
                  {/* Title */}
                  <h3 className="text-3xl md:text-4xl font-bold text-emerald-700 mb-3 group-hover:text-emerald-800 transition-colors duration-300 tracking-tight">
                    {expertise.name}
                  </h3>
                  
                  {/* Description */}
                  <p className="text-gray-600 text-lg md:text-xl leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
