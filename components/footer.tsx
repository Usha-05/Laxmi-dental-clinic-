...
export default function Footer() {
  return (
    <footer className="bg-[#1E603F] text-white">
      <div className="w-full px-2 sm:px-4 lg:px-6 pt-6 md:pt-8 lg:pt-10 pb-6 md:pb-8 lg:pb-10 footer-text-xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 md:mb-10">
          {/* About */}
          <div>
            <div className="relative w-full max-w-[500px] h-[175px] mb-4">
              <Image
          ...
          {/* Treatments */}
          <div>
            <h4 className="font-bold mb-6">Treatments</h4>
            <ul className="space-y-3">
              <li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <Phone size={26} className="flex-shrink-0 mt-0.5" />
                <a href="tel:+917794879535" className="opacity-90 hover:opacity-100 transition">
                  +91 77948 79535
                </a>
              </div>
              <div className="flex gap-3">
                <Mail size={26} className="flex-shrink-0 mt-0.5" />
              ...
              <div className="flex gap-3">
                <MapPin size={26} className="flex-shrink-0 mt-0.5" />
                <a 
        ...
        {/* Social Links */}
        <div className="border-t border-primary-foreground/20 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
