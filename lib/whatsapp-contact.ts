...
export function buildWhatsAppMessage(contact: ContactMessage): string {
...
Thank you for contacting Laxmi Face and Dental Hospital!`
}

export async function sendWhatsAppMessage(contact: ContactMessage): Promise<{ success: boolean; error?: string; whatsappLink?: string }> {
  ...
  console.log(
    "[WhatsApp] To enable automatic WhatsApp sending, configure one of:"
  )
  console.log(
    "  - WhatsApp Cloud API (FREE): WHATSAPP_ACCESS_TOKEN and WHATSAPP_PHONE_NUMBER_ID"
  )
  console.log(
    "  - Twilio: TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, TWILIO_WHATSAPP_FROM"
  )
  console.log(
    "  - Custom API: WHATSAPP_API_KEY and WHATSAPP_API_URL"
  )
  console.log(
