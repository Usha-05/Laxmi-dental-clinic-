import type { Appointment } from "./email"
...
export function buildWhatsAppMessage(appointment: Appointment): string {
...
export async function sendWhatsAppMessage(appointment: Appointment): Promise<{ success: boolean; error?: string; whatsappLink?: string }> {
