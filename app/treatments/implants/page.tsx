...
export default function ImplantsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-emerald-50/40 to-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl p-8 border border-emerald-200">
              <h3 className="text-2xl font-bold text-emerald-700 mb-6">Why Choose Dental Implants?</h3>
              <ul className="space-y-4">
                ...
                <li className="flex gap-3 items-start">
                  <CheckCircle2 className="text-emerald-600 flex-shrink-0 mt-1" size={20} />
                  <span className="text-gray-700 font-medium">Preserve jaw bone and prevent bone loss</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle2 className="text-emerald-600 flex-shrink-0 mt-1" size={20} />
                  <span className="text-gray-700 font-medium">Restore full chewing function</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle2 className="text-emerald-600 flex-shrink-0 mt-1" size={20} />
                  <span className="text-gray-700 font-medium">No need to alter adjacent healthy teeth</span>
                </li>
                <li className="flex gap-3 items-start">
                  <CheckCircle2 className="text-emerald-600 flex-shrink-0 mt-1" size={20} />
                  <span className="text-gray-700 font-medium">
          ...
          <div className="relative">
            <div className="rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-emerald-100 to-green-100">
              <img src="/female-patient-smile.jpg" alt="Dental Implants" className="w-full h-96 object-cover" />
            </div>
      ...
      {/* Treatment Process */}
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">The Implant Process</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { step: 2, title: "Implant Placement", desc: "Surgical placement of titanium implant in jawbone" },
            {
              step: 3,
              title: "Osseointegration",
              desc: "Healing period for implant to fuse with bone (3-6 months)",
            },
            { step: 4, title: "Crown Placement", desc: "Custom crown attached to implant for final restoration" },
          ].map((item) => (
            <div
              key={item.step}
          ...
          <div className="space-y-8">
            <div>
              ...
              <ul className="space-y-3 text-gray-700">
                <li>✓ Permanent, natural-looking tooth replacement</li>
                <li>✓ Preserve jaw bone and facial structure</li>
                <li>✓ Restore full chewing and speaking function</li>
                <li>✓ No impact on adjacent healthy teeth</li>
                <li>✓ Long-lasting solution with proper care</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Ideal Candidates</h3>
              <p className="text-gray-700 mb-3">Implants are suitable for:</p>
              <ul className="space-y-2 text-gray-700">
                <li>• Patients with good overall health</li>
                <li>• Adequate jaw bone density</li>
                <li>• Healthy gums and oral hygiene</li>
                <li>• Non-smokers or willing to quit</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl p-12 border border-emerald-200">
            ...
            <div className="space-y-4">
              <div className="pb-4 border-b border-emerald-200">
                ...
                <p className="text-sm text-gray-600">1-2 hours procedure with local anesthesia</p>
              </div>
              <div className="pb-4 border-b border-emerald-200">
                <p className="font-semibold text-gray-900">Healing Period</p>
                <p className="text-sm text-gray-600">3-6 months for osseointegration</p>
              </div>
              <div className="pb-4 border-b border-emerald-200">
                <p className="font-semibold text-gray-900">Crown Placement</p>
                <p className="text-sm text-gray-600">2-3 weeks after healing is complete</p>
              </div>
              <div>
                <p className="font-semibold text-gray-900">Longevity</p>
                <p className="text-sm text-gray-600">Lifetime with proper care and maintenance</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-emerald-600 to-green-600 rounded-2xl p-12 text-white text-center space-y-6">
          <h2 className="text-4xl font-bold">Restore Your Complete Smile</h2>
          <p className="text-xl text-emerald-50 max-w-2xl mx-auto">
            Schedule a consultation to see if dental implants are the right solution for replacing your missing teeth
          </p>
          <Link
            href="/#appointment"
